...
- **Quick Panels** - Pin any action into small dockable toolbars that stay visible while you work. Drag & drop straight from the wheel, share panels as files, and start from 4 built-in panels (Viewport, Placement, Lighting, Optimization).
