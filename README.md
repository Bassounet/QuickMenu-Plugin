...
Press **V** to open a fully customizable pie menu. Design your menus visually with a node graph editor, add context-aware switching, submenus, and 46+ built-in action types.
...
- **46+ Built-in Action Types** - Viewport, transform, play, build, spawn, blueprint operations, material, sequencer, Niagara, PCG, and more.
